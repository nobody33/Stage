...
#date de création : 10/05/19 par : Quentin Dhersin
#dernière modification le : 13/05/19 par : Quentin Dhersin

#Cette version est la deuxième version graphique finale
...
def recherche():
    messagebox.showinfo("info","recherche réussie")

    """effectuer la recherche dans la BD"""
    ...
    def modifierBD():
        ...
        if champ_compte_window_modifier.get() != "" and champ_nom_modifier.get() != "":
            ...
            if (len(champ_ouverture_date_modifier.get()) == 10 or len(champ_ouverture_date_modifier.get()) == 0) and (len(champ_fermeture_date_modifier.get()) == 10 or len(champ_fermeture_date_modifier.get()) == 0):
                ...
                treeview.insert("", 0, text=champ_compte_window_modifier.get(), values=(liste_type_modifier['selection'], champ_nom_modifier.get().upper(),
    ...
    def ajouterBD():
        ...
        if champ_compte_window_inserer.get() != "" and champ_nom_inserer.get() != "":
            ...
            if (len(champ_ouverture_date_inserer.get()) == 10 or len(champ_ouverture_date_inserer.get()) == 0) and (len(champ_fermeture_date_inserer.get()) == 10 or len(champ_fermeture_date_inserer.get()) == 0):
                #on ajoute la nouvelle ligne dans le tableau
                treeview.insert("", 0, text=champ_compte_window_inserer.get(), values=(liste_type_inserer['selection'], champ_nom_inserer.get().upper(),
...
#on peuple le treeview
i=0
while i < 30:
    treeview.insert("", "end", text="test"+str(i), values=("val"+str(i)))
    i+=1
